    ...
    public class BlackListController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddBlackList([FromBody]AddBlackListDTO dto)
        {
            try
            {
                ...
                ResponseModel<AddBlackListDTO> model = await BlackListService.AddBlackList(dto).ConfigureAwait(false);
                if (model is null)
                    return BadRequest();
        ...
        public async Task<IActionResult> GetAllBlackList()
        {
            try
            {
                ...
                CreateBuilderLogger.ConsoleText($"{HttpContext.Request.Path.Value}");
#endif
                ResponseModel<List<BlackListDTO>> model = await BlackListService.GetAllBlackList().ConfigureAwait(false);
                if (model is null)
                    return BadRequest();
        ...
        public async Task<IActionResult> GetAllBlackListCount()
        {
            try
            {
                ...
                CreateBuilderLogger.ConsoleText($"{HttpContext.Request.Path.Value}");
#endif
                ResponseModel<int?> model = await BlackListService.GetBlackListCountService().ConfigureAwait(false);
                if (model is null)
                    return BadRequest();
        ...
        public async Task<IActionResult> GetAllBlackList([FromQuery][Required]int pagenum, [FromQuery][Required]int pagesize)
        {
            try
            {
                ...
                ResponseModel<List<BlackListDTO>> model = await BlackListService.GetAllBlackListPageNation(pagenum, pagesize).ConfigureAwait(false);
                if (model is null)
                    return BadRequest();
        ...
        public async Task<IActionResult> UpdateBlackList(BlackListDTO dto)
        {
            try
            {
                ...
                ResponseModel<bool?> model = await BlackListService.UpdateBlackList(dto).ConfigureAwait(false);
                if (model is null)
                    return BadRequest();
        ...
        public async Task<IActionResult> DeleteBlackList([FromBody]List<int> delIdx)
        {
            try
            {
                ...
                ResponseModel<bool?> model = await BlackListService.DeleteBlackList(delIdx).ConfigureAwait(false);
                if (model is null)
                    return BadRequest();
