...
namespace FamTec.Server.Controllers.Facility
{
    ...
    public class ConstructFacilityController : ControllerBase
    {
        ...
        public async ValueTask<IActionResult> UpdateConstructFacility([FromForm] FacilityDTO dto, [FromForm] IFormFile? files)
        {
            try
            {
                if (HttpContext is null)
        ...
        public async ValueTask<IActionResult> DeleteConstructFacility([FromBody] List<int> delIdx)
        {
            try
            {
                ...
                ResponseUnit<bool?> model = await ConstructFacilityService.DeleteConstructFacilityService(HttpContext, delIdx);
                if (model is null)
                    return BadRequest();
