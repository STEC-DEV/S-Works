    ...
    public class StoreController : ControllerBase
    {
...
#endif
                ResponseModel<InOutListDTO?> model = await InStoreService.GetDashBoardInOutListData().ConfigureAwait(false);
        ...
        public async Task<IActionResult> GetInventoryAmount([FromQuery][Required]List<int> MaterialIdx)
        {
            try
            {
                ...
                ResponseModel<List<InventoryAmountDTO>>? model = await InStoreService.GetDashBoardInvenAmountData(MaterialIdx).ConfigureAwait(false);
        ...
        */
        ...
        public async Task<IActionResult> AddInStore([FromBody][Required] List<InOutInventoryDTO> dto)
        {
            try
            {
                ...
                ResponseModel<int?> model = await InStoreService.AddInStoreService(dto).ConfigureAwait(false);
                if (model is null)
                    return BadRequest();
        ...
        public async Task<IActionResult> OutInventoryService([FromBody][Required] List<InOutInventoryDTO> dto)
        {
            try
            {
                ...
                ResponseModel<FailResult?> model = await InStoreService.OutInventoryService(dto).ConfigureAwait(false);
                if (model is null)
                    return BadRequest();
        ...
        public async Task<IActionResult> GetInoutHistory()
        {
            try
            {
                ...
                CreateBuilderLogger.ConsoleText($"{HttpContext.Request.Path.Value}");
#endif
                ResponseModel<List<InOutHistoryListDTO>>? model = await InStoreService.GetInOutHistoryService().ConfigureAwait(false);
                if (model is null)
                    return BadRequest();
                if (model.code == 200)
                    return Ok(model);
        ...
        public async Task<IActionResult> GetInoutPageNationHistory([FromQuery][Required] int pagenum, [FromQuery][Required] int pagesize)
        {
            try
            {
                ...
                ResponseModel<List<InOutHistoryListDTO>>? model = await InStoreService.GetInoutPageNationHistoryService(pagenum, pagesize).ConfigureAwait(false);
                if (model is null)
                    return BadRequest();
        ...
        public async Task<IActionResult> GetAllInoutPlaceCount()
        {
            try
            {
                ...
                CreateBuilderLogger.ConsoleText($"{HttpContext.Request.Path.Value}");
#endif
                ResponseModel<int?> model = await InStoreService.GetPlaceInOutCountService().ConfigureAwait(false);
        ...
        public async Task<IActionResult> GetPlaceInventoryStatus([FromQuery][Required]List<int> materialid, [FromQuery][Required]bool type)
        {
            try
            {
                ...
                ResponseModel<List<MaterialHistory>>? model = await InStoreService.GetPlaceInventoryRecordService(materialid, type).ConfigureAwait(false);
        ...
        public async Task<IActionResult> PeriodicRecord([FromQuery][Required] List<int> materialid, [FromQuery][Required]DateTime Startdate, [FromQuery][Required]DateTime EndDate)
        {
            try
            {
                ...
                CreateBuilderLogger.ConsoleText($"{HttpContext.Request.Path.Value}");
#endif
                ResponseModel<List<PeriodicDTO>>? model = await InStoreService.PeriodicInventoryRecordService(materialid, Startdate, EndDate).ConfigureAwait(false);
        ...
        public async Task<IActionResult> GetLocationMaterial([FromQuery][Required]int materialid, [FromQuery][Required]int buildingid)
        {
            try
            {
                ...
                ResponseModel<List<InOutLocationDTO>> model = await InStoreService.GetMaterialRoomNumService(materialid, buildingid).ConfigureAwait(false);
                if (model is null)
                    return BadRequest();
        ...
        public async Task<IActionResult> GetLocationMaterialNum([FromQuery][Required]int materialid, [FromQuery][Required]int roomid)
        {
            try
            {
                ...
                ResponseModel<InOutLocationDTO> model = await InStoreService.GetMaterialRoomInventoryNumService(materialid, roomid).ConfigureAwait(false);
        ...
        public async Task<IActionResult> AddOutStoreList([FromQuery][Required]int roomid, [FromQuery][Required]int materialid, [FromQuery][Required]int outcount)
        {
            try
            {
                ...
                ResponseModel<InOutInventoryDTO>? model = await InStoreService.AddOutStoreList(roomid, materialid, outcount).ConfigureAwait(false);
                if (model is null)
                    return BadRequest();
                if (model.code == 200)
                    return Ok(model);
