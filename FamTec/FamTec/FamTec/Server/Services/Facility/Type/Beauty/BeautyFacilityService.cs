            ...
            try
            {
                ...
                if (model is not null)
                {
                    ...
                    if (room is not null)
                    {
                        ...
                        {
                            dto.Image = await FileService.GetImageFile(BeautyFileFolderPath, model.Image);
                        }
                ...
                if (model is not null)
                {
                    ...
                    if (updateBuilding == true)
                    {
                        if(files is not null) // 파일이 공백이 아닌경우
                        {
                            ...
                            {
                                // 파일삭제
                                bool DeleteFile = FileService.DeleteImageFile(BeautyFileFolderPath, deleteFileName);
                            }
                        }
                        else // 파일이 공백인 경우
                        {
