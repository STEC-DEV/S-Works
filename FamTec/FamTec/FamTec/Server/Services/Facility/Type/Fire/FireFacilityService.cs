...
namespace FamTec.Server.Services.Facility.Type.Fire
{
    public class FireFacilityService : IFireFacilityService
    {
        ...
        private readonly ILogger<FireFacilityService> BuilderLogger;
        ...
        public FireFacilityService(
            ...
            ILogger<FireFacilityService> _builderlogger)
        {
        ...
        public async Task<ResponseUnit<FacilityDetailDTO>> GetFireDetailFacilityService(HttpContext context, int facilityId)
        {
            try
            {
                ...
                if(!String.IsNullOrWhiteSpace(model.Image))
                {
                    ...
                    dto.Image = await FileService.GetImageFile(FireFileFolderPath, model.Image).ConfigureAwait(false); // 이미지 Byte[]
                }
