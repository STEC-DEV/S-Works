...
namespace FamTec.Server.Services.Facility.Type.Electronic
{
    public class ElectronicFacilityService : IElectronicFacilityService
    {
        ...
        /// <returns></returns>
        public async Task<byte[]?> DownloadElectronicFacilityForm()
        {
            try
            {
        ...
        /// <returns></returns>
        public async Task<ResponseModel<bool>> ImportElectronicFacilityService(IFormFile? file)
        {
            try
            {
                var context = HttpContextAccessor.HttpContext;
        ...
        /// <returns></returns>
        public async Task<ResponseModel<FacilityDTO>> AddElectronicFacilityService(FacilityDTO dto, IFormFile? files)
        {
            try
            {
                var context = HttpContextAccessor.HttpContext;
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public async Task<ResponseModel<List<FacilityListDTO>>> GetElectronicFacilityListService()
        {
            try
            {
                var context = HttpContextAccessor.HttpContext;
        ...
        /// <returns></returns>
        public async Task<ResponseModel<FacilityDetailDTO>> GetElectronicDetailFacilityService(int facilityId, bool isMobile)
        {
            try
            {
                var context = HttpContextAccessor.HttpContext;
                ...
                if(isMobile)
                {
                    ...
                    {
                        byte[]? ImageBytes = await FileService.GetImageFile(ElectronicFileFolderPath, model.Image).ConfigureAwait(false);
        ...
        public async Task<ResponseModel<bool?>> UpdateElectronicFacilityService(FacilityDTO dto, IFormFile? files)
        {
            try
            {
                var context = HttpContextAccessor.HttpContext;
                ...
                if(!String.IsNullOrWhiteSpace(deleteFileName))
                {
                    FileService.DeleteImageFile(ElectronicFileFolderPath, deleteFileName);
                }
                ...
                else
                {
                    ...
                    if(!String.IsNullOrWhiteSpace(RemoveTemp))
                    {
                        try
                        {
                            FileService.DeleteImageFile(ElectronicFileFolderPath, RemoveTemp);
                        }
                        catch(Exception ex)
                        {
        ...
        public async Task<ResponseModel<bool?>> DeleteElectronicFacilityService(List<int> delIdx)
        {
            try
            {
                var context = HttpContextAccessor.HttpContext;
