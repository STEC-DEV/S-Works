...
namespace FamTec.Server.Services.Facility.Type.Network
{
    public interface INetworkFacilityService
    {
        ...
        /// <returns></returns>
        public ValueTask<ResponseUnit<AddFacilityDTO>?> AddNetworkFacilityService(HttpContext? context, AddFacilityDTO? dto, IFormFile? files);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        public ValueTask<ResponseUnit<bool?>> UpdateNetworkFacilityService(HttpContext? context, UpdateFacilityDTO? dto, IFormFile? files);
