...
namespace FamTec.Server.Services.Facility.Type.Lift
{
    public class LiftFacilityService : ILiftFacilityService
    {
        ...
        private readonly ILogger<LiftFacilityService> BuilderLogger;
        ...
        public async Task<ResponseUnit<FacilityDetailDTO>> GetLiftDetailFacilityService(HttpContext context, int facilityId)
        {
            try
            {
                ...
                if (!String.IsNullOrWhiteSpace(model.Image))
                {
                    ...
                    dto.Image = await FileService.GetImageFile(LiftFileFolderPath, model.Image).ConfigureAwait(false);
                }
