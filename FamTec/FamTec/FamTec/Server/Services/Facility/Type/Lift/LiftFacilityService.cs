...
namespace FamTec.Server.Services.Facility.Type.Lift
{
    public class LiftFacilityService : ILiftFacilityService
    {
        ...
        /// <returns></returns>
        public async ValueTask<ResponseUnit<AddFacilityDTO>?> AddLiftFacilityService(HttpContext? context, AddFacilityDTO? dto, IFormFile? files)
        {
            try
            {
        ...
        public async ValueTask<ResponseUnit<bool?>> UpdateLiftFacilityService(HttpContext? context, UpdateFacilityDTO? dto, IFormFile? files)
        {
            try
            {
                string? FileName = String.Empty;
