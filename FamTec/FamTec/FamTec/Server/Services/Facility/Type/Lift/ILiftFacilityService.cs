...
namespace FamTec.Server.Services.Facility.Type.Lift
{
    public interface ILiftFacilityService
    {
        ...
        /// <returns></returns>
        public ValueTask<ResponseUnit<AddFacilityDTO>?> AddLiftFacilityService(HttpContext? context, AddFacilityDTO? dto, IFormFile? files);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        public ValueTask<ResponseUnit<bool?>> UpdateLiftFacilityService(HttpContext? context, UpdateFacilityDTO? dto, IFormFile? files);
