...
namespace FamTec.Server.Services.Meter.Energy
{
    public class EnergyService : IEnergyService
    {
        ...
        /// <returns></returns>
        public async Task<ResponseModel<AddEnergyDTO>> AddEnergyService(AddEnergyDTO dto)
        {
            try
            {
                ...
                if (context is null || dto is null)
                    return new ResponseModel<AddEnergyDTO>() { message = "잘못된 요청입니다.", data = null, code = 404 };
                ...
                if (AlreadyCheck is not null)
                    return new ResponseModel<AddEnergyDTO>() { message = "이미 값이 있습니다.", data = null, code = 200 };
                ...
                if (model is not null)
                    return new ResponseModel<AddEnergyDTO>() { message = "요청이 정상 처리되었습니다.", data = dto, code = 200 };
                else
                    return new ResponseModel<AddEnergyDTO>() { message = "잘못된 요청입니다.", data = null, code = 404 };
            }
            catch(Exception ex)
            {
                ...
                return new ResponseModel<AddEnergyDTO>() { message = "서버에서 요청을 처리하지 못하였습니다.", data = null, code = 500 };
            }
        }
